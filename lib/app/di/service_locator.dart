...
import 'package:strop_app/data/repositories/project_repository_impl.dart';
import 'package:strop_app/data/repositories/user_repository_impl.dart';
...
Future<void> init() async {
  ...
  sl
    ...
    ..registerLazySingleton(GeoapifyService.new)
    ...
    ..registerLazySingleton<ProjectRepository>(
      () => ProjectRepositoryImpl(sl(), sl<LocalDatabase>()),
    )
    ..registerLazySingleton<UserRepository>(
      () => UserRepositoryImpl(sl<SupabaseClient>(), sl<LocalDatabase>()),
    )
    ..registerLazySingleton(
      () => UserProfileRepository(sl<SupabaseClient>()),
    );
}
